...
public class ItemController {
    ...
    @GetMapping(value = "/admin/item/new") //상품등록
    public String itemForm(Model model){
        model.addAttribute("itemFormDto",new ItemFormDto());
        return "item/itemForm";
    }
    @PostMapping(value = "/admin/item/new") //상품등록
    ...
    @PostMapping(value = "/admin/item/{itemId}") //상품수정
    ...
    @GetMapping(value = "/item/{itemId}") // 상품 상세페이지
